...
export default function RegisterRegistrations() {
  const { id } = useParams();
  ...
  return (
    <Container>
      <DetailsMenu name="Matrícula" form="formNewRegistrations" edit={!!id} />

      <Form id="formNewRegistrations" onSubmit={handleSubmit}>
