      ...
      <Container>
        ...
        <Row>
          <Col>
            ...
            <p>
              ambiente: <b>{process.env.NODE_ENV}</b>
            </p>
          </Col>
        </Row>
        ...
        <h3>
          Componente do tipo: <b>Styled Component</b>
        </h3>
        ...
        <h3>
          Componente do tipo: <b>Stateless Component</b>
        </h3>
        <Person person={person} />

        <h3>
          Componente do tipo: <b>Stateful Component</b>
        </h3>
        <Video src={`${process.env.PUBLIC_URL}videos/introducao-react.webm`} />

        <h3>
          Componente do tipo: <b>Feature Component</b>
        </h3>
        <People />
      </Container>
    </>
